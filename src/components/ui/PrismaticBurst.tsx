...
const PrismaticBurst = ({
  ...
  // Use shared visibility hook for consistent viewport/tab visibility detection
  ...
  useEffect(() => {
    ...
    return () => {
      // Cancel animation frame (cleanup handled in animation loop useEffect)
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      const dt = Math.max(0, now - lastFrameTimeRef.current) * 0.001;
      ...
      program.uniforms.uTime.value = accumTimeRef.current;

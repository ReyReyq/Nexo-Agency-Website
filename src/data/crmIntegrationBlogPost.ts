...
<section class="cta-section" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); border-radius: 24px; padding: 48px 32px; margin: 48px 0; text-align: center;">
  <h2 style="color: #ffffff; font-size: 2rem; margin-bottom: 16px;">צריכים עזרה בהטמעת CRM לעסק?</h2>

  <p style="color: rgba(255,255,255,0.8); font-size: 1.1rem; margin-bottom: 24px;">ב-NEXO אנחנו מתמחים ב<a href="/services/ai-automation" style="color: #ec4899;">אוטומציה עסקית</a> והטמעת מערכות CRM לעסקים ישראליים.<br/>אנחנו עוזרים לכם לבחור את המערכת הנכונה, להטמיע אותה בצורה מושלמת, ולהפיק ממנה את המקסימום.</p>

  <p style="color: #ffffff; font-size: 1.25rem; font-weight: bold; margin-bottom: 32px;">רוצים לדעת איזה CRM מתאים לעסק שלכם?</p>
  ...
  <p style="color: rgba(255,255,255,0.6); font-size: 0.9rem; margin-top: 20px;">30 דקות ייעוץ ללא התחייבות - נבין את הצרכים ונמליץ על הפתרון המתאים</p>
</section>

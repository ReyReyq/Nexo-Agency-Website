...
<section class="cta-section" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); border-radius: 24px; padding: 48px 32px; margin: 48px 0; text-align: center;">
  <h2 style="color: #ffffff; font-size: 2rem; margin-bottom: 16px;">רוצים לבנות מכונת מכירות אוטומטית?</h2>

  <p style="color: rgba(255,255,255,0.8); font-size: 1.1rem; margin-bottom: 24px;">ב-NEXO אנחנו מתמחים ב<a href="/services/digital-marketing" style="color: #ec4899;">שיווק דיגיטלי</a> ובניית אוטומציות אימייל שמוכרות 24/7.<br/>מרצף קבלת פנים ועד שחזור עגלות נטושות - אנחנו יודעים מה עובד בשוק הישראלי.</p>

  <p style="color: #ffffff; font-size: 1.25rem; font-weight: bold; margin-bottom: 32px;">מוכנים להפוך את האימייל מרקטינג למנוע צמיחה?</p>
  ...
  <p style="color: rgba(255,255,255,0.6); font-size: 0.9rem; margin-top: 20px;">ניתוח אסטרטגיה חינם | ללא התחייבות | תוכנית עבודה תוך 48 שעות</p>
</section>
...
<section class="sources">
  ...
  readTime: 22,
  image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1200&q=80&fm=webp&fit=crop",

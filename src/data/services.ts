...
const mainServices: Service[] = [
  ...
  },
  {
    ...
    tier: "main",
    icon: Megaphone,
    image: "/images/services/seo-optimization.webp",
...
const secondaryServices: Service[] = [
  {
    ...
    subServices: [
      { id: "technical-seo", name: "SEO טכני", description: "אופטימיזציה טכנית מקיפה - מהירות, זחילה ואינדקס" },
      { id: "local-seo", name: "SEO מקומי", description: "קידום בתוצאות מקומיות ו-Google Business" },
      { id: "content-seo", name: "תוכן ממוקד SEO", description: "אסטרטגיית תוכן ומחקר מילות מפתח" },
      { id: "link-building", name: "בניית קישורים", description: "בניית פרופיל קישורים איכותי" },
    ],
    process: [
  ...
  },
  {
    ...
    subServices: [
      { id: "instagram-marketing", name: "שיווק באינסטגרם", description: "אסטרטגיה, תוכן, רילס וסטוריז" },
      { id: "facebook-marketing", name: "שיווק בפייסבוק", description: "דפים, קבוצות ומעורבות קהילתית" },
      { id: "linkedin-marketing", name: "שיווק בלינקדאין", description: "שיווק B2B ורשת מקצועית" },
      { id: "tiktok-marketing", name: "שיווק בטיקטוק", description: "וידאו קצר וטרנדים ויראליים" },
    ],
    process: [
  ...
  },
  {
    ...
    subServices: [
      { id: "market-research", name: "מחקר שוק", description: "ניתוח מתחרים ומיצוב בשוק" },
      { id: "digital-audit", name: "אודיט דיגיטלי", description: "הערכת מצב וזיהוי פערים" },
      { id: "growth-strategy", name: "אסטרטגיית צמיחה", description: "תכנון סקיילינג והתרחבות" },
      { id: "conversion-optimization", name: "אופטימיזציית המרות", description: "CRO ואופטימיזציית משפכים" },
    ],
    process: [
  ...
  },
  {
    ...
    icon: Smartphone,
    image: "/images/services/app-development.webp",
    ...
    subServices: [
      { id: "ios-apps", name: "אפליקציות iOS", description: "אפליקציות נייטיב לאייפון ואייפד" },
      { id: "android-apps", name: "אפליקציות אנדרואיד", description: "אפליקציות נייטיב לאנדרואיד" },
      { id: "cross-platform", name: "חוצות פלטפורמות", description: "React Native ו-Flutter" },
      { id: "pwa", name: "אפליקציות PWA", description: "אפליקציות ווב מתקדמות" },
    ],
    process: [
  ...
  },
  {
    ...
    parentService: "web-development",
    icon: Code,
    image: "/images/services/custom-development.webp",
    ...
    subServices: [
      { id: "saas-development", name: "פיתוח SaaS", description: "פלטפורמות תוכנה כשירות" },
      { id: "api-development", name: "פיתוח API", description: "REST APIs ואינטגרציות" },
      { id: "dashboard-systems", name: "מערכות דשבורד", description: "פאנלים ומערכות ניהול" },
      { id: "automation-systems", name: "מערכות אוטומציה", description: "אוטומציה של תהליכים עסקיים" },
    ],
    process: [

...
import { businessWebsitesLandingPage } from "@/data/landingPages/businessWebsites";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// בניית אתרים לעסקים
// ============================================
// SEO-optimized landing page for small and medium businesses
// targeting "website building for businesses" in Hebrew

const BusinessWebsites = memo(() => {
  const data = businessWebsitesLandingPage;
...
BusinessWebsites.displayName = 'BusinessWebsites';

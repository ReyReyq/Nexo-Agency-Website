...
import { freeWebsiteLandingPage } from "@/data/landingPages/freeWebsite";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// ============================================
// FREE WEBSITE BUILDING LANDING PAGE
// בניית אתרים בחינם
// ============================================
// SEO-optimized landing page targeting people searching for free website solutions
// Strategy: Convert "free" searchers by showing hidden costs and professional value
// Target keyword: בניית אתרים בחינם (720 monthly searches)

const FreeWebsite = memo(() => {
  const data = freeWebsiteLandingPage;
  ...
  return (
    <>
      ...
      <main dir="rtl" lang="he">
        ...
        {/* Pain Points Section - Hidden costs of "free" */}
        <LandingPainPoints
          content={data.painPoints}
          accentColor={data.theme.accentColor}
        />

        {/* Features Section - What professional sites offer */}
        <LandingFeatures
...
FreeWebsite.displayName = 'FreeWebsite';

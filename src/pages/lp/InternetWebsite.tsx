...
import { internetWebsiteLandingPage } from "@/data/landingPages/internetWebsite";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// ============================================
// INTERNET WEBSITE LANDING PAGE
// בניית אתר אינטרנט
// ============================================
// SEO-optimized landing page for generic website building services
// targeting "internet website building" in Hebrew (720 monthly searches)

const InternetWebsite = memo(() => {
  const data = internetWebsiteLandingPage;
...
InternetWebsite.displayName = 'InternetWebsite';

export default InternetWebsite;

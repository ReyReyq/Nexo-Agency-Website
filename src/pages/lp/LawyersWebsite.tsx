...
import { lawyersLandingPage } from "@/data/landingPages/lawyers";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// ============================================
// LAWYERS WEBSITE LANDING PAGE
// בניית אתרים לעורכי דין
// ============================================
// SEO-optimized landing page for legal professionals
// targeting "website building for lawyers" in Hebrew

const LawyersWebsite = memo(() => {
  const data = lawyersLandingPage;
...
LawyersWebsite.displayName = 'LawyersWebsite';

export default LawyersWebsite;

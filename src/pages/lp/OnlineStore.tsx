...
import { onlineStoreLandingPage } from "@/data/landingPages/onlineStore";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// ============================================
// SEO-optimized landing page for e-commerce businesses
// targeting "online store building" in Hebrew

const OnlineStore = memo(() => {
  const data = onlineStoreLandingPage;
...
OnlineStore.displayName = 'OnlineStore';

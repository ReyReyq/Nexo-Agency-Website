...
import { portfolioSiteLandingPage } from "@/data/landingPages/portfolioSite";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// ============================================
// SEO-optimized landing page for businesses seeking portfolio/image websites
// targeting "אתר תדמיתי" in Hebrew (320 monthly searches)

const PortfolioSite = memo(() => {
  const data = portfolioSiteLandingPage;
...
PortfolioSite.displayName = 'PortfolioSite';

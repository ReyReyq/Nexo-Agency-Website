...
import { portfolioWebsiteLandingPage } from "@/data/landingPages/portfolioWebsite";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// בניית אתר תדמיתי
// ============================================
// SEO-optimized landing page for portfolio/image websites
// targeting "portfolio website building" in Hebrew

const PortfolioWebsite = memo(() => {
  const data = portfolioWebsiteLandingPage;
...
PortfolioWebsite.displayName = 'PortfolioWebsite';

...
import { salesWebsiteLandingPage } from "@/data/landingPages/salesWebsite";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// בניית אתר מכירות
// ============================================
// SEO-optimized landing page for e-commerce and sales websites
// targeting "בניית אתר מכירות" in Hebrew (720 monthly searches)

const SalesWebsite = memo(() => {
  const data = salesWebsiteLandingPage;
...
SalesWebsite.displayName = 'SalesWebsite';

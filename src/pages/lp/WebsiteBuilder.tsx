...
import { websiteBuilderLandingPage } from "@/data/landingPages/websiteBuilder";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// Differentiates professional services from DIY builders

const WebsiteBuilder = memo(() => {
  const data = websiteBuilderLandingPage;

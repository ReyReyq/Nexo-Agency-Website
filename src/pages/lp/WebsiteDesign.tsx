...
import { websiteDesignLandingPage } from "@/data/landingPages/websiteDesign";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// עיצוב אתרים
// ============================================
// SEO-optimized landing page for website design services
// targeting "עיצוב אתרים" (website design) in Hebrew

const WebsiteDesign = memo(() => {
  const data = websiteDesignLandingPage;

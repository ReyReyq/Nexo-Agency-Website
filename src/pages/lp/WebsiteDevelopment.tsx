...
import { websiteDevelopmentLandingPage } from "@/data/landingPages/websiteDevelopment";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// Focus: Custom development, technical excellence, scalability

const WebsiteDevelopment = memo(() => {
  const data = websiteDevelopmentLandingPage;
...
WebsiteDevelopment.displayName = 'WebsiteDevelopment';

...
import { websiteSetupLandingPage } from "@/data/landingPages/websiteSetup";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// הקמת אתר אינטרנט
// ============================================
// SEO-optimized landing page for first-time website owners
// targeting "website setup/establishment" in Hebrew

const WebsiteSetup = memo(() => {
  const data = websiteSetupLandingPage;
...
WebsiteSetup.displayName = 'WebsiteSetup';

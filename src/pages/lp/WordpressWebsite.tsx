...
import { wordpressWebsiteLandingPage } from "@/data/landingPages/wordpressWebsite";
import {
  LandingHero,
  LandingPainPoints,
  LandingFeatures,
...
// בניית אתר וורדפרס
// ============================================
// SEO-optimized landing page for WordPress website development
// targeting "בניית אתר וורדפרס" (880 monthly searches)

const WordpressWebsite = memo(() => {
  const data = wordpressWebsiteLandingPage;
...
WordpressWebsite.displayName = 'WordpressWebsite';
